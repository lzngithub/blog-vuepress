...
module.exports = {
  ...
  head: [
    ...
    ['link', { rel: 'icon', href: '/img/icon.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
    ...
    ['meta', { name: 'theme-color', content: '#1ba784' }], // 移动浏览器主题颜色
  ...
  themeConfig: {
    ...
    author: {
      ...
      name: '行思', // 必需
      link: 'https://github.com/lzngithub', // 可选的
    },
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar: `img/avatar/avatar${Math.floor(Math.random() * 10 + 1)}.png`,
      name: '行思',
      slogan: '前端小菜鸡(✪ω✪)',
    },
    social: {
      ...
      icons: [
        ...
        },
        {
          ...
          title: 'GitHub',
          link: 'https://github.com/lzngithub',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://y.qq.com/n/ryqq/playlist/8335388176',
        },
      ],
    },
    footer: {
      ...
      copyrightInfo:
        '行思 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a> 备案号：<a href="https://beian.miit.gov.cn/">桂ICP备2022001115号</a>', // 博客版权信息，支持a标签
    },
